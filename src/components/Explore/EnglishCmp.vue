 ...
 <template>
    <div>
      ...
      ><i class="fa fa-home fa-2x" aria-hidden="true"></i>
        ...
        <div class="container-fluid">
          ...
          <h2 class="cat-heading" style='color:#d7dee1' >Talk Show</h2> 
        </div>
      </nav>
      <div class="container px-4" id='card'>
        <div class="row gx-5" >
        <div class="col"  v-for='show in  moviesBasedOnTalkShow.slice(0,10)' :key="show.score" style="margin-bottom:2%">       
    ...
    computed: {
      ...
      moviesBasedOnTalkShow(){
            return this.shows.filter(show=>show.type=="Talk Show")
          },
