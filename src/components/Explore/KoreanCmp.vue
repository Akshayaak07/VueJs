  ...
  <div>
    ...
    <a href="/ExploreCmp/:data" style="text-align: right; color: #79e9d2"
      ...
      <div class="container-fluid">
        ...
        <h2 class="cat-heading" style='color:#d7dee1' >Drama</h2> 
      </div>
    </nav>
    <div class="container px-4" id='card'>
      <div class="row gx-5" >
      <div class="col"  v-for='show in   moviesBasedOnDrama.slice(0,10)' :key="show.score" style="margin-bottom:2%">       
 ...
 computed: {
       ...
       moviesBasedOnDrama(){
             return this.shows.filter(show=>show.genres[0]=="Drama")
           },
